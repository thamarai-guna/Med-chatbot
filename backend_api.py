...
async def chat_query(request: ChatQueryRequest):
    ...
    Reuses existing RAG logic from rag_engine.py
    """
    try:
        ...
        # Initialize RAG engine (reuses existing logic)
        ...
        # Get response (same AI behavior as Streamlit)
...
async def upload_documents(
    ...
    vector_store_name: str = "DefaultVectorDB",
    merge_with_existing: bool = False
):
    """
    Upload and process documents
    Reuses falcon.py chunking and embedding logic
    """
    try:
        import falcon
        ...
        create_new = not merge_with_existing
        falcon.embedding_storing(
            split=split_docs,
            create_new_vs=create_new,
            existing_vector_store="" if create_new else vector_store_name,
            new_vs_name=vector_store_name
        )
